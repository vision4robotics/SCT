...
dataset_dict = dict(
    ...
    uavdark=DatasetInfo(module=pt % "uavdark", class_name="UAVDARKDataset", kwargs=dict()),
    darktrack=DatasetInfo(module=pt % "darktrack", class_name="DarkTrackDataset", kwargs=dict()),
