...
from toolkit.datasets import OTBDataset, UAVDataset, LaSOTDataset, \
        VOTDataset, NFSDataset, VOTLTDataset, UAVDARKDataset, UAVDTDataset
...
parser.add_argument('--dataset', '-d', type=str, default='DarkTrack',
                    help='dataset name')
...
def main():
    ...
    if 'OTB' in args.dataset:
        ...
        benchmark.show_result(success_ret, precision_ret, norm_precision_ret,
                show_video_level=args.show_video_level)
    elif 'uavdark' in args.dataset:
        root = '/media/ye/Luck/dataset/UAVDark135_TSP_out/Sequences'
        ...
        benchmark.show_result(success_ret, precision_ret,
                show_video_level=args.show_video_level)
    elif 'DarkTrack' == args.dataset:
        root = '/media/ye/Luck/dataset/DarkTrack'
        dataset = UAVDARKDataset(args.dataset, root)
        dataset.set_tracker(tracker_dir, trackers)
        benchmark = OPEBenchmark(dataset)
        success_ret = {}
        ...
        benchmark.show_result(f1_result,
                show_video_level=args.show_video_level)
    elif 'UAVDT' in args.dataset: # 添加了数据集
        root = '/media/ye/Luck/dataset/UAVDT/data_seq'
